...
extern inline const float VectorDistance(const sf::Vector2f& v1, const sf::Vector2f& v2)
{
...
template <class T>
extern inline const sf::Vector2<T> VectorBetween(const sf::Vector2<T>& v1, const sf::Vector2<T>& v2)
{
	return sf::Vector2<T>(v2.x - v1.x, v2.y - v1.y);
}

extern inline const float DegreesOfVector(const sf::Vector2f& v)
{
